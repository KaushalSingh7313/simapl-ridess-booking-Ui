...
//
//     // Create animation.
//     final animationDuration = (widget.animationDuration.inMicroseconds < 0) ? Duration() : widget.animationDuration;
//
...
//             // [MAIN LOGIC]
//
//             if ((value != animationController.upperBound) && (animationController.value >= animationController.upperBound)) {
